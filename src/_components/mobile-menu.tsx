...
export const MobileMenu = () => {
    ...
    return (
        <>
            ...
            <div className={`md:hidden fixed top-0 right-0 w-full h-screen backdrop-blur z-20 transition-transform duration-700 ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
